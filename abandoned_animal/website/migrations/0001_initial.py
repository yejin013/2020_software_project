    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.CharField(blank=True, choices=[('기억에 남는 추억의 장소는?', '기억에 남는 추억의 장소는?'), ('자신의 인생 좌우명은?', '자신의 인생 좌우명은?'), ('자신의 보물 제1호는?', '자신의 보물 제1호는?'), ('가장 기억에 남는 선생님 성함은?', '가장 기억에 남는 선생님 성함은?'), ('추억하고 싶은 날짜가 있다면?', '추억하고 싶은 날짜가 있다면?'), ('유년시절 가장 생각나는 친구 이름은?', '인상 깊게 읽은 책 이름은?'), ('인상 깊게 읽은 책 이름은?', '인상 깊게 읽은 책 이름은?'), ('읽은 책 중에서 좋아하는 구절이 있다면?', '읽은 책 중에서 좋아하는 구절이 있다면?'), ('자신이 두번째로 존경하는 인물은?', '자신이 두번째로 존경하는 인물은?'), ('초등학교 때 기억에 남는 짝궁 이름은?', '초등학교 때 기억에 남는 짝궁 이름은?'), ('다시 태어나면 되고 싶은 것은?', '다시 태어나면 되고 싶은 것은?'), ('내가 좋아하는 캐릭터는?', '내가 좋아하는 캐릭터는?'), ('자신의 반려동물의 이름은?', '자신의 반려동물의 이름은?')], max_length=30, null=True)),
