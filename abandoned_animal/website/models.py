...
class Post(models.Model):
    ...
    shelter = models.CharField(max_length=300, verbose_name = '보호소', null=True, blank=True)
    phone = models.CharField(max_length=20, verbose_name = '보호소전화번호', null=True, blank=True)
